              ...
              <% ArrayList<Student> students=(ArrayList<Student>) request.getAttribute("students") ;
                  ...
                  <div onclick="toggleModal()" class="add-action-box">
                    <button class="btn btn-primary btn-lg btn-square rounded-pill" data-bs-toggle="modal"
                      ...
                      <span class="btn-icon icofont-student fs-48"></></span>
                    </button>
                  </div>
                          ...
                          <div class="modal-body">
                            ...
                            <div class="row my-2">
                              <div class="form-group col-12 col-sm-4">
                                <input required="true" name="firstName" class="form-control" type="text"
                                  placeholder="first Name">
                              </div>
                              <div class="form-group col-12 col-sm-4">
                                <input name="lastName" required="true" class="form-control" type="text"
                                  placeholder="last Name">
                              </div>
                              <div class="form-group my-2 col-12 col-sm-4">
                                <input name="surname" required="true" class="form-control" type="text"
                                  placeholder="surname">
                              </div>
                            </div>
                            <div class="row my-2">
                              <div class="form-group col-12 col-sm-6">
                                <input name="regNo" required="true" class="form-control" type="text"
                                  placeholder="reg No">
                              </div>
                            ...
                            <div class="row my-2">
                              <div class="form-group col-12 col-sm-6">
                                <input name="phone" required="true" class="form-control" type="text"
                                  placeholder="phone">
                              </div>
                              <div class="form-group col-12 col-sm-6">
                                <input name="email" required="true" class="form-control" type="email"
                                  placeholder="email">
                              </div>
                            </div>
                            <div class="row my-2">
                            ...
                            <div class="row my-2">
                              <div class="form-group col-12 col-sm-6">
                                <input name="nationality" required="true" class="form-control" type="text"
                                  placeholder="nationality">
                              </div>
                              <div class="form-group col-12 col-sm-6">
                                <input name="religion" required="true" class="form-control" type="text"
                            ...
                            <div class="row my-2">
                              ...
                              <div class="form-group col-12 col-sm-4">
                                <input name="fDemail" class="form-control" type="text"
                                  placeholder="Family doctor email">
                              </div>
                              <div class="form-group col-12 col-sm-4">
                                <input name="fDphone" class="form-control" type="text"
                            ...
                            <div class="row my-2">
                              ...
                              <div class="form-group col-12 col-sm-4">
                                <input name="reasonAdmission" class="form-control" type="text"
                                  placeholder="reason Admission">
                              </div>
                              <div class="form-group col-12 col-sm-4">
                                <input name="previousIllness" class="form-control" type="text"
                                  placeholder="previous Illness">
                              </div>
                              <div class="form-group col-12 col-sm-4">
                                <input name="privateHospital" class="form-control mt-2" type="text"
                                  placeholder="private HospitalS">
                              </div>
                            ...
                            <div class="row my-2">
                              <div class="form-group col-6 col-sm-8">
                                <input name="anyObservation" class="form-control" type="text"
